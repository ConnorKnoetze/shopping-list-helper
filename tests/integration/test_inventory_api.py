...
def test_inventory_api_and_update(client, memory_repo):
    ...
    user = make_user(memory_repo, username="ivan", email="ivan@example.com", password="Password1")
    ...
    resp3 = client.post(f"/inventory/update/{ing.name}", data="notjson", headers={"Content-Type": "application/json"})
...
def test_inventory_api_missing_item(client, memory_repo):
    ...
    user = make_user(memory_repo, username="jen", email="jen@example.com", password="Password1")
...
def test_inventory_api_invalid_unit(client, memory_repo):
    ...
    user = make_user(memory_repo, username="leo", email="leo@gmail.com", password="Password1")
...
def test_inventory_api_negative_quantity(client, memory_repo):
    ...
    user = make_user(memory_repo, username="mia", email="mia@gmail.com", password="Password1")
...
def test_inventory_api_non_numeric_quantity(client, memory_repo):
    ...
    user = make_user(memory_repo, username="nina", email="nina@gmail.com", password="Password1")
